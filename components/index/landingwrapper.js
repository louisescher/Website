  ...
  return (
      <div className='flex flex-row content-center items-center h-auto'>
        <div className='textwrapper ml-4 mr-4 md:ml-16 mt-12 md:mr-16'>
          ...
          <div className='flex flex-row text-white mt-4'>
            <div className='w-8 mr-4'>
              <Link href='https://twitter.com/codedotspirit'>
                <a target={"_blank"} className="twitter_icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill='#ffffff' id='twitter_icon'>
            ...
            <div className='w-8 mr-4'>
              <Link href='https://github.com/SpiritLetsPlays'>
                <a target={"_blank"} className="github_icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill='#ffffff' id='github_icon'>
